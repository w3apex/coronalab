            ...
            <div class="card">
                <div class="card-body">
                    <div class="row header-title">
                        <div class="col-6">
                            <h4 class="">Create New Patient</h4>
                        </div>
                        <div class="col-6">
                    ...
                    <form action="{{ route('patients.store')}}" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="first_name" name="first_name" aria-describedby="nameHelp" placeholder="Enter a first name">
                            </div>
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="last_name">Last Name</label>
                                <input type="text" class="form-control" id="last_name" name="last_name" aria-describedby="nameHelp" placeholder="Enter a first name">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="email">Email</label>
                                <input type="email" class="form-control" id="email" name="email" aria-describedby="nameHelp" placeholder="Enter Email address">
                            </div>
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="phone">Phone Number</label>
                                <input type="text" class="form-control" id="phone" name="phone" aria-describedby="nameHelp" placeholder="Enter phone">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                        ...
                        <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Save Patient</button>
                    </form>
                </div>
            </div>
        </div>
