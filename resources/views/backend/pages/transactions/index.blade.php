            ...
            <div class="card">
                <div class="card-body">
                    <div class="row header-title">
                        ...
                        <div class="col-6">
                            <a class="btn btn-success text-white pull-right " href="{{ route('reports.create')}}">Create New Transaction</a>
                        </div>
                    </div>
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>3</td>
                                    <td>
                                        <a class="btn btn-success text-white d-inline" href="">Edit</a>
